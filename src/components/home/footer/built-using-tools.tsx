  ...
  return (
    <div className={'mx-auto max-w-7xl text-center px-8 mt-24 mb-24'}>
      ...
      <div className={'flex flex-row flex-wrap gap-6 justify-center md:justify-between items-center mt-8 md:gap-1'}>
        ...
        <Image src={'/assets/icons/logo/tailwind-logo.svg'} alt={'Tailwind logo'}   width={194} height={24} />
        ...
        <Image src={'/assets/icons/logo/shadcn-logo.svg'}   alt={'shadcn/ui logo'}  width={137} height={32} />
      </div>
    </div>
  );
}
